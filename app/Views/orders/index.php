...
<div class="col-lg-12">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <?php if (session()->getFlashdata('order_saved')) : ?>
                <?php echo '<p class="alert alert-success w-100 h-100">' . session()->getFlashdata('order_saved') . '</p>'; ?>
            <?php endif; ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="card-footer">
                                    <a href="orders/edit/<?= $order['order_id']; ?>" class="btn btn-primary">Edit</a>
